...
export function scalarMult(n: ByteArray, p: ByteArray):ByteArray {
    //checkArrayTypes(n, p);
...
export function scalarMult_base(n: ByteArray):ByteArray {
    //checkArrayTypes(n);
...
export function _scalarMult(q: ByteArray, n: ByteArray, p: ByteArray): i32 {
...
export function _scalarMult_base(q: ByteArray, n: ByteArray): i32 {
