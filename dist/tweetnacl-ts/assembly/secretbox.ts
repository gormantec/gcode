...
export function secretbox_open(box: ByteArray, nonce: ByteArray, key: ByteArray): ByteArray|null {
    ...
    if (c.length < SecretBoxLength.Zero || _secretbox_open(m, c, c.length, nonce, key) !== 0) return null;

    return m.subarray(SecretBoxLength.Zero);
}

// low level
function _secretbox(c: ByteArray, m: ByteArray, d: i32, n: ByteArray, k: ByteArray): i32 {
    if (d < 32) return -1;
...
function _secretbox_open(m: ByteArray, c: ByteArray, d: i32, n: ByteArray, k: ByteArray): i32 {
...
export function _onetimeauth(out: ByteArray, outpos: i32, m: ByteArray, mpos: i32, n: i32, k: ByteArray): i32 {
...
function _onetimeauth_verify(h: ByteArray, hpos: i32, m: ByteArray, mpos: i32, n: i32, k: ByteArray): i32 {
