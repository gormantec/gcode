...
export function checkLengths(k: ByteArray, n: ByteArray):void {
...
export function checkBoxLengths(pk: ByteArray, sk: ByteArray):void {
...
export function checkArrayTypes(array: ByteArray[]):void {
