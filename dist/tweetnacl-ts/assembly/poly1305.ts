...
export function poly1305_init(key: ByteArray): Poly1305 {
    ...
    let t0:i32, t1:i32, t2:i32, t3:i32, t4:i32, t5:i32, t6:i32, t7:i32;
...
export function poly1305_blocks(self: Poly1305, m: ByteArray, mpos: number, bytes: number):void {
    const hibit = self.fin ? 0 : (1 << 11);

    let t0:i32, t1:i32, t2:i32, t3:i32, t4:i32, t5:i32, t6:i32, t7:i32, c:i32;
    let d0:i32, d1:i32, d2:i32, d3:i32, d4:i32, d5:i32, d6:i32, d7:i32, d8:i32, d9:i32;

    const h:Uint16Array =self.h;
    const r:Uint16Array = self.r;
...
export function poly1305_finish(self: Poly1305, mac: ByteArray, macpos: number):void {
    const g = HalfArray(10);
    let c:i32, mask:i32, f:i32, i:i32;

    const buffer=self.buffer, h=self.h, pad=self.pad, leftover=self.leftover;
...
export function poly1305_update(self: Poly1305, m: ByteArray, mpos: number, bytes: number):void {
    let i:i32, want:i32;
