const PRECACHE = 'precache-v1-19aoi051qh';
const RUNTIME = 'runtime-19aoi051qh';
const PRECACHE_URLS = [
  '/apps/19aoi051qh/index.html',
  '/apps/19aoi051qh/index.html?mockFrame=iphoneX',
  '/apps/19aoi051qh/icon.png',
  '/apps/19aoi051qh/192x192.icon.png',
  '/apps/19aoi051qh/512x512.icon.png',
  '/apps/19aoi051qh/manifest.json',
