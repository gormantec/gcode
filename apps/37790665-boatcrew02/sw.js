const PRECACHE = 'precache-v1-37790665-boatcrew02';
const RUNTIME = 'runtime-37790665-boatcrew02';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew02/index.html',
  '/apps/37790665-boatcrew02/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew02/icon.png',
  '/apps/37790665-boatcrew02/192x192.icon.png',
  '/apps/37790665-boatcrew02/512x512.icon.png',
  '/apps/37790665-boatcrew02/manifest.json',
