const PRECACHE = 'precache-v1-37790665-gcode70x';
const RUNTIME = 'runtime-37790665-gcode70x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode70x/index.html',
  '/apps/37790665-gcode70x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode70x/icon.png',
  '/apps/37790665-gcode70x/192x192.icon.png',
  '/apps/37790665-gcode70x/512x512.icon.png',
  '/apps/37790665-gcode70x/manifest.json',
