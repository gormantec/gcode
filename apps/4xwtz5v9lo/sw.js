const PRECACHE = 'precache-v1-4xwtz5v9lo';
const RUNTIME = 'runtime-4xwtz5v9lo';
const PRECACHE_URLS = [
  '/apps/4xwtz5v9lo/index.html',
  '/apps/4xwtz5v9lo/index.html?mockFrame=iphoneX',
  '/apps/4xwtz5v9lo/icon.png',
  '/apps/4xwtz5v9lo/splash.png',
  '/apps/4xwtz5v9lo/180x180.icon.png',
  '/apps/4xwtz5v9lo/192x192.icon.png',
  '/apps/4xwtz5v9lo/512x512.icon.png',
  '/apps/4xwtz5v9lo/manifest.json',
