const PRECACHE = 'precache-v1-529ru0nt3d';
const RUNTIME = 'runtime-529ru0nt3d';
const PRECACHE_URLS = [
  '/apps/529ru0nt3d/index.html',
  '/apps/529ru0nt3d/index.html?mockFrame=iphoneX',
  '/apps/529ru0nt3d/icon.png',
  '/apps/529ru0nt3d/splash.png',
  '/apps/529ru0nt3d/180x180.icon.png',
  '/apps/529ru0nt3d/192x192.icon.png',
  '/apps/529ru0nt3d/512x512.icon.png',
  '/apps/529ru0nt3d/manifest.json',
