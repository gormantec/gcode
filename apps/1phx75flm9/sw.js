const PRECACHE = 'precache-v1-1phx75flm9';
const RUNTIME = 'runtime-1phx75flm9';
const PRECACHE_URLS = [
  '/apps/1phx75flm9/index.html',
  '/apps/1phx75flm9/index.html?mockFrame=iphoneX',
  '/apps/1phx75flm9/icon.png',
  '/apps/1phx75flm9/192x192.icon.png',
  '/apps/1phx75flm9/512x512.icon.png',
  '/apps/1phx75flm9/manifest.json',
