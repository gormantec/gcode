const PRECACHE = 'precache-v1-37790665-gcode65x';
const RUNTIME = 'runtime-37790665-gcode65x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode65x/index.html',
  '/apps/37790665-gcode65x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode65x/icon.png',
  '/apps/37790665-gcode65x/192x192.icon.png',
  '/apps/37790665-gcode65x/512x512.icon.png',
  '/apps/37790665-gcode65x/manifest.json',
