const PRECACHE = 'precache-v1-37790665-gcode';
const RUNTIME = 'runtime-37790665-gcode';
const PRECACHE_URLS = [
  '/apps/37790665-gcode/index.html',
  '/apps/37790665-gcode/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode/icon.png',
  '/apps/37790665-gcode/splash.icon.png',
  '/apps/37790665-gcode/180x180.icon.png',
  '/apps/37790665-gcode/192x192.icon.png',
  '/apps/37790665-gcode/512x512.icon.png',
  '/apps/37790665-gcode/manifest.json',
