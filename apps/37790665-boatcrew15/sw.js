const PRECACHE = 'precache-v1-37790665-boatcrew15';
const RUNTIME = 'runtime-37790665-boatcrew15';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew15/index.html',
  '/apps/37790665-boatcrew15/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew15/icon.png',
  '/apps/37790665-boatcrew15/192x192.icon.png',
  '/apps/37790665-boatcrew15/512x512.icon.png',
  '/apps/37790665-boatcrew15/manifest.json',
