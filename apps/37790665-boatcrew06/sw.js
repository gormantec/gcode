const PRECACHE = 'precache-v1-37790665-boatcrew06';
const RUNTIME = 'runtime-37790665-boatcrew06';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew06/index.html',
  '/apps/37790665-boatcrew06/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew06/icon.png',
  '/apps/37790665-boatcrew06/192x192.icon.png',
  '/apps/37790665-boatcrew06/512x512.icon.png',
  '/apps/37790665-boatcrew06/manifest.json',
