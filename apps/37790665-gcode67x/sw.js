const PRECACHE = 'precache-v1-37790665-gcode67x';
const RUNTIME = 'runtime-37790665-gcode67x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode67x/index.html',
  '/apps/37790665-gcode67x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode67x/icon.png',
  '/apps/37790665-gcode67x/192x192.icon.png',
  '/apps/37790665-gcode67x/512x512.icon.png',
  '/apps/37790665-gcode67x/manifest.json',
