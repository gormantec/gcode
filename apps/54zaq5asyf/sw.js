const PRECACHE = 'precache-v1-54zaq5asyf';
const RUNTIME = 'runtime-54zaq5asyf';
const PRECACHE_URLS = [
  '/apps/54zaq5asyf/index.html',
  '/apps/54zaq5asyf/index.html?mockFrame=iphoneX',
  '/apps/54zaq5asyf/icon.png',
  '/apps/54zaq5asyf/192x192.icon.png',
  '/apps/54zaq5asyf/512x512.icon.png',
  '/apps/54zaq5asyf/manifest.json',
