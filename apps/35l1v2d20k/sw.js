const PRECACHE = 'precache-v1-35l1v2d20k';
const RUNTIME = 'runtime-35l1v2d20k';
const PRECACHE_URLS = [
  '/apps/35l1v2d20k/index.html',
  '/apps/35l1v2d20k/index.html?mockFrame=iphoneX',
  '/apps/35l1v2d20k/icon.png',
  '/apps/35l1v2d20k/splash.png',
  '/apps/35l1v2d20k/180x180.icon.png',
  '/apps/35l1v2d20k/192x192.icon.png',
  '/apps/35l1v2d20k/512x512.icon.png',
  '/apps/35l1v2d20k/manifest.json',
