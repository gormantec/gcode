const PRECACHE = 'precache-v1-23lrd1ljh1';
const RUNTIME = 'runtime-23lrd1ljh1';
const PRECACHE_URLS = [
  '/apps/23lrd1ljh1/index.html',
  '/apps/23lrd1ljh1/index.html?mockFrame=iphoneX',
  '/apps/23lrd1ljh1/icon.png',
  '/apps/23lrd1ljh1/splash.png',
  '/apps/23lrd1ljh1/180x180.icon.png',
  '/apps/23lrd1ljh1/192x192.icon.png',
  '/apps/23lrd1ljh1/512x512.icon.png',
  '/apps/23lrd1ljh1/manifest.json',
  'https://gcode.com.au/css/pwa.css'
];
self.addEventListener('install', event => {event.waitUntil(caches.open(PRECACHE).then(cache =>{let r=null;try{r=cache.addAll(PRECACHE_URLS);}catch(e){console.log(e);};return r;}).then(self.skipWaiting()));});
