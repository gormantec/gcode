const PRECACHE = 'precache-v1-4xwsk3oemb';
const RUNTIME = 'runtime-4xwsk3oemb';
const PRECACHE_URLS = [
  '/apps/4xwsk3oemb/index.html',
  '/apps/4xwsk3oemb/index.html?mockFrame=iphoneX',
  '/apps/4xwsk3oemb/icon.png',
  '/apps/4xwsk3oemb/192x192.icon.png',
  '/apps/4xwsk3oemb/512x512.icon.png',
  '/apps/4xwsk3oemb/manifest.json',
