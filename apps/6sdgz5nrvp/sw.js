const PRECACHE = 'precache-v1-6sdgz5nrvp';
const RUNTIME = 'runtime-6sdgz5nrvp';
const PRECACHE_URLS = [
  '/apps/6sdgz5nrvp/index.html',
  '/apps/6sdgz5nrvp/index.html?mockFrame=iphoneX',
  '/apps/6sdgz5nrvp/icon.png',
  '/apps/6sdgz5nrvp/192x192.icon.png',
  '/apps/6sdgz5nrvp/512x512.icon.png',
  '/apps/6sdgz5nrvp/manifest.json',
