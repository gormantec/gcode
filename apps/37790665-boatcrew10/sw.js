const PRECACHE = 'precache-v1-37790665-boatcrew10';
const RUNTIME = 'runtime-37790665-boatcrew10';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew10/index.html',
  '/apps/37790665-boatcrew10/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew10/icon.png',
  '/apps/37790665-boatcrew10/192x192.icon.png',
  '/apps/37790665-boatcrew10/512x512.icon.png',
  '/apps/37790665-boatcrew10/manifest.json',
