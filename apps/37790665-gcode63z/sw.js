const PRECACHE = 'precache-v1-37790665-gcode63z';
const RUNTIME = 'runtime-37790665-gcode63z';
const PRECACHE_URLS = [
  '/apps/37790665-gcode63z/index.html',
  '/apps/37790665-gcode63z/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode63z/icon.png',
  '/apps/37790665-gcode63z/192x192.icon.png',
  '/apps/37790665-gcode63z/512x512.icon.png',
  '/apps/37790665-gcode63z/manifest.json',
