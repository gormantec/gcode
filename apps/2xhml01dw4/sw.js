const PRECACHE = 'precache-v1-2xhml01dw4';
const RUNTIME = 'runtime-2xhml01dw4';
const PRECACHE_URLS = [
  '/apps/2xhml01dw4/index.html',
  '/apps/2xhml01dw4/index.html?mockFrame=iphoneX',
  '/apps/2xhml01dw4/icon.png',
  '/apps/2xhml01dw4/splash.png',
  '/apps/2xhml01dw4/180x180.icon.png',
  '/apps/2xhml01dw4/192x192.icon.png',
  '/apps/2xhml01dw4/512x512.icon.png',
  '/apps/2xhml01dw4/manifest.json',
