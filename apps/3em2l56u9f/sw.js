const PRECACHE = 'precache-v1-3em2l56u9f';
const RUNTIME = 'runtime-3em2l56u9f';
const PRECACHE_URLS = [
  '/apps/3em2l56u9f/index.html',
  '/apps/3em2l56u9f/index.html?mockFrame=iphoneX',
  '/apps/3em2l56u9f/icon.png',
  '/apps/3em2l56u9f/192x192.icon.png',
  '/apps/3em2l56u9f/512x512.icon.png',
  '/apps/3em2l56u9f/manifest.json',
