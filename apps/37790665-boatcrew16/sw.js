const PRECACHE = 'precache-v1-37790665-boatcrew16';
const RUNTIME = 'runtime-37790665-boatcrew16';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew16/index.html',
  '/apps/37790665-boatcrew16/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew16/icon.png',
  '/apps/37790665-boatcrew16/192x192.icon.png',
  '/apps/37790665-boatcrew16/512x512.icon.png',
  '/apps/37790665-boatcrew16/manifest.json',
