const PRECACHE = 'precache-v1-1zma90sqk2';
const RUNTIME = 'runtime-1zma90sqk2';
const PRECACHE_URLS = [
  '/apps/1zma90sqk2/index.html',
  '/apps/1zma90sqk2/index.html?mockFrame=iphoneX',
  '/apps/1zma90sqk2/icon.png',
  '/apps/1zma90sqk2/192x192.icon.png',
  '/apps/1zma90sqk2/512x512.icon.png',
  '/apps/1zma90sqk2/manifest.json',
