const PRECACHE = 'precache-v1-37m936cqbw';
const RUNTIME = 'runtime-37m936cqbw';
const PRECACHE_URLS = [
  '/apps/37m936cqbw/index.html',
  '/apps/37m936cqbw/index.html?mockFrame=iphoneX',
  '/apps/37m936cqbw/icon.png',
  '/apps/37m936cqbw/splash.png',
  '/apps/37m936cqbw/180x180.icon.png',
  '/apps/37m936cqbw/192x192.icon.png',
  '/apps/37m936cqbw/512x512.icon.png',
  '/apps/37m936cqbw/manifest.json',
