const PRECACHE = 'precache-v1-37790665-boatcrew18';
const RUNTIME = 'runtime-37790665-boatcrew18';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew18/index.html',
  '/apps/37790665-boatcrew18/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew18/icon.png',
  '/apps/37790665-boatcrew18/192x192.icon.png',
  '/apps/37790665-boatcrew18/512x512.icon.png',
  '/apps/37790665-boatcrew18/manifest.json',
