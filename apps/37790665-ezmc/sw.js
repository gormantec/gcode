const PRECACHE = 'precache-v1-37790665-ezmc';
const RUNTIME = 'runtime-37790665-ezmc';
const PRECACHE_URLS = [
  '/apps/37790665-ezmc/index.html',
  '/apps/37790665-ezmc/index.html?mockFrame=iphoneX',
  '/apps/37790665-ezmc/icon.png',
  '/apps/37790665-ezmc/splash.icon.png',
  '/apps/37790665-ezmc/180x180.icon.png',
  '/apps/37790665-ezmc/192x192.icon.png',
  '/apps/37790665-ezmc/512x512.icon.png',
  '/apps/37790665-ezmc/manifest.json',
