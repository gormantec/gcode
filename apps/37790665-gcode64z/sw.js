const PRECACHE = 'precache-v1-37790665-gcode64z';
const RUNTIME = 'runtime-37790665-gcode64z';
const PRECACHE_URLS = [
  '/apps/37790665-gcode64z/index.html',
  '/apps/37790665-gcode64z/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode64z/icon.png',
  '/apps/37790665-gcode64z/192x192.icon.png',
  '/apps/37790665-gcode64z/512x512.icon.png',
  '/apps/37790665-gcode64z/manifest.json',
