const PRECACHE = 'precache-v1-6htoj1xkeu';
const RUNTIME = 'runtime-6htoj1xkeu';
const PRECACHE_URLS = [
  '/apps/6htoj1xkeu/index.html',
  '/apps/6htoj1xkeu/index.html?mockFrame=iphoneX',
  '/apps/6htoj1xkeu/icon.png',
  '/apps/6htoj1xkeu/192x192.icon.png',
  '/apps/6htoj1xkeu/512x512.icon.png',
  '/apps/6htoj1xkeu/manifest.json',
