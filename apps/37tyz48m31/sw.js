const PRECACHE = 'precache-v1-37tyz48m31';
const RUNTIME = 'runtime-37tyz48m31';
const PRECACHE_URLS = [
  '/apps/37tyz48m31/index.html',
  '/apps/37tyz48m31/index.html?mockFrame=iphoneX',
  '/apps/37tyz48m31/icon.png',
  '/apps/37tyz48m31/192x192.icon.png',
  '/apps/37tyz48m31/512x512.icon.png',
  '/apps/37tyz48m31/manifest.json',
