const PRECACHE = 'precache-v1-09dhj2ugvw';
const RUNTIME = 'runtime-09dhj2ugvw';
const PRECACHE_URLS = [
  '/apps/09dhj2ugvw/index.html',
  '/apps/09dhj2ugvw/index.html?mockFrame=iphoneX',
  '/apps/09dhj2ugvw/icon.png',
  '/apps/09dhj2ugvw/192x192.icon.png',
  '/apps/09dhj2ugvw/512x512.icon.png',
  '/apps/09dhj2ugvw/manifest.json',
