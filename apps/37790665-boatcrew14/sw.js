const PRECACHE = 'precache-v1-37790665-boatcrew14';
const RUNTIME = 'runtime-37790665-boatcrew14';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew14/index.html',
  '/apps/37790665-boatcrew14/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew14/icon.png',
  '/apps/37790665-boatcrew14/192x192.icon.png',
  '/apps/37790665-boatcrew14/512x512.icon.png',
  '/apps/37790665-boatcrew14/manifest.json',
