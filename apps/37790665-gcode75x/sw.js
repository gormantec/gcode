const PRECACHE = 'precache-v1-37790665-gcode75x';
const RUNTIME = 'runtime-37790665-gcode75x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode75x/index.html',
  '/apps/37790665-gcode75x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode75x/icon.png',
  '/apps/37790665-gcode75x/192x192.icon.png',
  '/apps/37790665-gcode75x/512x512.icon.png',
  '/apps/37790665-gcode75x/manifest.json',
