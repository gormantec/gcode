const PRECACHE = 'precache-v1-37790665-boatcrew12';
const RUNTIME = 'runtime-37790665-boatcrew12';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew12/index.html',
  '/apps/37790665-boatcrew12/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew12/icon.png',
  '/apps/37790665-boatcrew12/192x192.icon.png',
  '/apps/37790665-boatcrew12/512x512.icon.png',
  '/apps/37790665-boatcrew12/manifest.json',
