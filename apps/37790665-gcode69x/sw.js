const PRECACHE = 'precache-v1-37790665-gcode69x';
const RUNTIME = 'runtime-37790665-gcode69x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode69x/index.html',
  '/apps/37790665-gcode69x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode69x/icon.png',
  '/apps/37790665-gcode69x/192x192.icon.png',
  '/apps/37790665-gcode69x/512x512.icon.png',
  '/apps/37790665-gcode69x/manifest.json',
