const PRECACHE = 'precache-v1-1bezb59cy4';
const RUNTIME = 'runtime-1bezb59cy4';
const PRECACHE_URLS = [
  '/apps/1bezb59cy4/index.html',
  '/apps/1bezb59cy4/index.html?mockFrame=iphoneX',
  '/apps/1bezb59cy4/icon.png',
  '/apps/1bezb59cy4/splash.png',
  '/apps/1bezb59cy4/180x180.icon.png',
  '/apps/1bezb59cy4/192x192.icon.png',
  '/apps/1bezb59cy4/512x512.icon.png',
  '/apps/1bezb59cy4/manifest.json',
