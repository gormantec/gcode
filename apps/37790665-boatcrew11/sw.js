const PRECACHE = 'precache-v1-37790665-boatcrew11';
const RUNTIME = 'runtime-37790665-boatcrew11';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew11/index.html',
  '/apps/37790665-boatcrew11/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew11/icon.png',
  '/apps/37790665-boatcrew11/192x192.icon.png',
  '/apps/37790665-boatcrew11/512x512.icon.png',
  '/apps/37790665-boatcrew11/manifest.json',
