...
{
      constructor(_text) {
        super({"position":"relative",height:"100%","verticalAlign": "middle","child":new Div({"position":"relative","verticalAlign": "middle","height":"100%",paddingTop:"15px",textAlign:"center","innerText":_text})});
      }
}