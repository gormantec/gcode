const PRECACHE = 'precache-v1-37790665-boatcrew08';
const RUNTIME = 'runtime-37790665-boatcrew08';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew08/index.html',
  '/apps/37790665-boatcrew08/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew08/icon.png',
  '/apps/37790665-boatcrew08/192x192.icon.png',
  '/apps/37790665-boatcrew08/512x512.icon.png',
  '/apps/37790665-boatcrew08/manifest.json',
