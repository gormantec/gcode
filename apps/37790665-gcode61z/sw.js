const PRECACHE = 'precache-v1-37790665-gcode61z';
const RUNTIME = 'runtime-37790665-gcode61z';
const PRECACHE_URLS = [
  '/apps/37790665-gcode61z/index.html',
  '/apps/37790665-gcode61z/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode61z/icon.png',
  '/apps/37790665-gcode61z/192x192.icon.png',
  '/apps/37790665-gcode61z/512x512.icon.png',
  '/apps/37790665-gcode61z/manifest.json',
