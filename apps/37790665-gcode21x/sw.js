const PRECACHE = 'precache-v1-37790665-gcode21x';
const RUNTIME = 'runtime-37790665-gcode21x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode21x/index.html',
  '/apps/37790665-gcode21x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode21x/icon.png',
  '/apps/37790665-gcode21x/192x192.icon.png',
  '/apps/37790665-gcode21x/512x512.icon.png',
  '/apps/37790665-gcode21x/manifest.json',
