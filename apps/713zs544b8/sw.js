const PRECACHE = 'precache-v1-713zs544b8';
const RUNTIME = 'runtime-713zs544b8';
const PRECACHE_URLS = [
  '/apps/713zs544b8/index.html',
  '/apps/713zs544b8/index.html?mockFrame=iphoneX',
  '/apps/713zs544b8/icon.png',
  '/apps/713zs544b8/splash.png',
  '/apps/713zs544b8/180x180.icon.png',
  '/apps/713zs544b8/192x192.icon.png',
  '/apps/713zs544b8/512x512.icon.png',
  '/apps/713zs544b8/manifest.json',
