const PRECACHE = 'precache-v1-37790665-boatcrew71x';
const RUNTIME = 'runtime-37790665-boatcrew71x';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew71x/index.html',
  '/apps/37790665-boatcrew71x/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew71x/icon.png',
  '/apps/37790665-boatcrew71x/192x192.icon.png',
  '/apps/37790665-boatcrew71x/512x512.icon.png',
  '/apps/37790665-boatcrew71x/manifest.json',
