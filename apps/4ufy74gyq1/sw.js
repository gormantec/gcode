const PRECACHE = 'precache-v1-4ufy74gyq1';
const RUNTIME = 'runtime-4ufy74gyq1';
const PRECACHE_URLS = [
  '/apps/4ufy74gyq1/index.html',
  '/apps/4ufy74gyq1/index.html?mockFrame=iphoneX',
  '/apps/4ufy74gyq1/icon.png',
  '/apps/4ufy74gyq1/192x192.icon.png',
  '/apps/4ufy74gyq1/512x512.icon.png',
  '/apps/4ufy74gyq1/manifest.json',
