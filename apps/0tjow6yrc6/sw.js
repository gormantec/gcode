const PRECACHE = 'precache-v1-0tjow6yrc6';
const RUNTIME = 'runtime-0tjow6yrc6';
const PRECACHE_URLS = [
  '/apps/0tjow6yrc6/index.html',
  '/apps/0tjow6yrc6/index.html?mockFrame=iphoneX',
  '/apps/0tjow6yrc6/icon.png',
  '/apps/0tjow6yrc6/splash.png',
  '/apps/0tjow6yrc6/180x180.icon.png',
  '/apps/0tjow6yrc6/192x192.icon.png',
  '/apps/0tjow6yrc6/512x512.icon.png',
  '/apps/0tjow6yrc6/manifest.json',
