const PRECACHE = 'precache-v1-2wvhr1jngd';
const RUNTIME = 'runtime-2wvhr1jngd';
const PRECACHE_URLS = [
  '/apps/2wvhr1jngd/index.html',
  '/apps/2wvhr1jngd/index.html?mockFrame=iphoneX',
  '/apps/2wvhr1jngd/icon.png',
  '/apps/2wvhr1jngd/192x192.icon.png',
  '/apps/2wvhr1jngd/512x512.icon.png',
  '/apps/2wvhr1jngd/manifest.json',
