const PRECACHE = 'precache-v1-37790665-gcode76x';
const RUNTIME = 'runtime-37790665-gcode76x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode76x/index.html',
  '/apps/37790665-gcode76x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode76x/icon.png',
  '/apps/37790665-gcode76x/192x192.icon.png',
  '/apps/37790665-gcode76x/512x512.icon.png',
  '/apps/37790665-gcode76x/manifest.json',
