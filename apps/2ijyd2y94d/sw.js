const PRECACHE = 'precache-v1-2ijyd2y94d';
const RUNTIME = 'runtime-2ijyd2y94d';
const PRECACHE_URLS = [
  '/apps/2ijyd2y94d/index.html',
  '/apps/2ijyd2y94d/index.html?mockFrame=iphoneX',
  '/apps/2ijyd2y94d/icon.png',
  '/apps/2ijyd2y94d/192x192.icon.png',
  '/apps/2ijyd2y94d/512x512.icon.png',
  '/apps/2ijyd2y94d/manifest.json',
