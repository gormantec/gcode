const PRECACHE = 'precache-v1-2153n3hdd2';
const RUNTIME = 'runtime-2153n3hdd2';
const PRECACHE_URLS = [
  '/apps/2153n3hdd2/index.html',
  '/apps/2153n3hdd2/index.html?mockFrame=iphoneX',
  '/apps/2153n3hdd2/icon.png',
  '/apps/2153n3hdd2/192x192.icon.png',
  '/apps/2153n3hdd2/512x512.icon.png',
  '/apps/2153n3hdd2/manifest.json',
