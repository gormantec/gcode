const PRECACHE = 'precache-v1-64nbb2nms1';
const RUNTIME = 'runtime-64nbb2nms1';
const PRECACHE_URLS = [
  '/apps/64nbb2nms1/index.html',
  '/apps/64nbb2nms1/index.html?mockFrame=iphoneX',
  '/apps/64nbb2nms1/icon.png',
  '/apps/64nbb2nms1/192x192.icon.png',
  '/apps/64nbb2nms1/512x512.icon.png',
  '/apps/64nbb2nms1/manifest.json',
