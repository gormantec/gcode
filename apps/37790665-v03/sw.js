const PRECACHE = 'precache-v1-37790665-v03';
const RUNTIME = 'runtime-37790665-v03';
const PRECACHE_URLS = [
  '/apps/37790665-v03/index.html',
  '/apps/37790665-v03/index.html?mockFrame=iphoneX',
  '/apps/37790665-v03/icon.png',
  '/apps/37790665-v03/192x192.icon.png',
  '/apps/37790665-v03/512x512.icon.png',
  '/apps/37790665-v03/manifest.json',
