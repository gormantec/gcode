const PRECACHE = 'precache-v1-2gdfj60muc';
const RUNTIME = 'runtime-2gdfj60muc';
const PRECACHE_URLS = [
  '/apps/2gdfj60muc/index.html',
  '/apps/2gdfj60muc/index.html?mockFrame=iphoneX',
  '/apps/2gdfj60muc/icon.png',
  '/apps/2gdfj60muc/192x192.icon.png',
  '/apps/2gdfj60muc/512x512.icon.png',
  '/apps/2gdfj60muc/manifest.json',
