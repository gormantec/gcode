const PRECACHE = 'precache-v1-0cg6i26ceq';
const RUNTIME = 'runtime-0cg6i26ceq';
const PRECACHE_URLS = [
  '/apps/0cg6i26ceq/index.html',
  '/apps/0cg6i26ceq/index.html?mockFrame=iphoneX',
  '/apps/0cg6i26ceq/icon.png',
  '/apps/0cg6i26ceq/splash.png',
  '/apps/0cg6i26ceq/180x180.icon.png',
  '/apps/0cg6i26ceq/192x192.icon.png',
  '/apps/0cg6i26ceq/512x512.icon.png',
  '/apps/0cg6i26ceq/manifest.json',
