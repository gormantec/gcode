const PRECACHE = 'precache-v1-37790665-ezmc2';
const RUNTIME = 'runtime-37790665-ezmc2';
const PRECACHE_URLS = [
  '/apps/37790665-ezmc2/index.html',
  '/apps/37790665-ezmc2/index.html?mockFrame=iphoneX',
  '/apps/37790665-ezmc2/icon.png',
  '/apps/37790665-ezmc2/splash.icon.png',
  '/apps/37790665-ezmc2/180x180.icon.png',
  '/apps/37790665-ezmc2/192x192.icon.png',
  '/apps/37790665-ezmc2/512x512.icon.png',
  '/apps/37790665-ezmc2/manifest.json',
