const PRECACHE = 'precache-v1-2m1j16a4yn';
const RUNTIME = 'runtime-2m1j16a4yn';
const PRECACHE_URLS = [
  '/apps/2m1j16a4yn/index.html',
  '/apps/2m1j16a4yn/index.html?mockFrame=iphoneX',
  '/apps/2m1j16a4yn/icon.png',
  '/apps/2m1j16a4yn/splash.png',
  '/apps/2m1j16a4yn/180x180.icon.png',
  '/apps/2m1j16a4yn/192x192.icon.png',
  '/apps/2m1j16a4yn/512x512.icon.png',
  '/apps/2m1j16a4yn/manifest.json',
