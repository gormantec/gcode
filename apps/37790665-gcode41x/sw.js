const PRECACHE = 'precache-v1-37790665-gcode41x';
const RUNTIME = 'runtime-37790665-gcode41x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode41x/index.html',
  '/apps/37790665-gcode41x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode41x/icon.png',
  '/apps/37790665-gcode41x/192x192.icon.png',
  '/apps/37790665-gcode41x/512x512.icon.png',
  '/apps/37790665-gcode41x/manifest.json',
