const PRECACHE = 'precache-v1-37790665-gcode30x';
const RUNTIME = 'runtime-37790665-gcode30x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode30x/index.html',
  '/apps/37790665-gcode30x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode30x/icon.png',
  '/apps/37790665-gcode30x/192x192.icon.png',
  '/apps/37790665-gcode30x/512x512.icon.png',
  '/apps/37790665-gcode30x/manifest.json',
