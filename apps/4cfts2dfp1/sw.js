const PRECACHE = 'precache-v1-4cfts2dfp1';
const RUNTIME = 'runtime-4cfts2dfp1';
const PRECACHE_URLS = [
  '/apps/4cfts2dfp1/index.html',
  '/apps/4cfts2dfp1/index.html?mockFrame=iphoneX',
  '/apps/4cfts2dfp1/icon.png',
  '/apps/4cfts2dfp1/192x192.icon.png',
  '/apps/4cfts2dfp1/512x512.icon.png',
  '/apps/4cfts2dfp1/manifest.json',
