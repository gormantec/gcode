const PRECACHE = 'precache-v1-37790665-gcode62z';
const RUNTIME = 'runtime-37790665-gcode62z';
const PRECACHE_URLS = [
  '/apps/37790665-gcode62z/index.html',
  '/apps/37790665-gcode62z/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode62z/icon.png',
  '/apps/37790665-gcode62z/192x192.icon.png',
  '/apps/37790665-gcode62z/512x512.icon.png',
  '/apps/37790665-gcode62z/manifest.json',
