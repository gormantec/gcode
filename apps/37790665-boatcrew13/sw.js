const PRECACHE = 'precache-v1-37790665-boatcrew13';
const RUNTIME = 'runtime-37790665-boatcrew13';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew13/index.html',
  '/apps/37790665-boatcrew13/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew13/icon.png',
  '/apps/37790665-boatcrew13/192x192.icon.png',
  '/apps/37790665-boatcrew13/512x512.icon.png',
  '/apps/37790665-boatcrew13/manifest.json',
