const PRECACHE = 'precache-v1-3fjpf6c8e0';
const RUNTIME = 'runtime-3fjpf6c8e0';
const PRECACHE_URLS = [
  '/apps/3fjpf6c8e0/index.html',
  '/apps/3fjpf6c8e0/index.html?mockFrame=iphoneX',
  '/apps/3fjpf6c8e0/icon.png',
  '/apps/3fjpf6c8e0/splash.png',
  '/apps/3fjpf6c8e0/180x180.icon.png',
  '/apps/3fjpf6c8e0/192x192.icon.png',
  '/apps/3fjpf6c8e0/512x512.icon.png',
  '/apps/3fjpf6c8e0/manifest.json',
