const PRECACHE = 'precache-v1-3k95a6pdr2';
const RUNTIME = 'runtime-3k95a6pdr2';
const PRECACHE_URLS = [
  '/apps/3k95a6pdr2/index.html',
  '/apps/3k95a6pdr2/index.html?mockFrame=iphoneX',
  '/apps/3k95a6pdr2/icon.png',
  '/apps/3k95a6pdr2/192x192.icon.png',
  '/apps/3k95a6pdr2/512x512.icon.png',
  '/apps/3k95a6pdr2/manifest.json',
