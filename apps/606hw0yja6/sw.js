const PRECACHE = 'precache-v1-606hw0yja6';
const RUNTIME = 'runtime-606hw0yja6';
const PRECACHE_URLS = [
  '/apps/606hw0yja6/index.html',
  '/apps/606hw0yja6/index.html?mockFrame=iphoneX',
  '/apps/606hw0yja6/icon.png',
  '/apps/606hw0yja6/192x192.icon.png',
  '/apps/606hw0yja6/512x512.icon.png',
  '/apps/606hw0yja6/manifest.json',
