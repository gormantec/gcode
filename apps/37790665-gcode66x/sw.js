const PRECACHE = 'precache-v1-37790665-gcode66x';
const RUNTIME = 'runtime-37790665-gcode66x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode66x/index.html',
  '/apps/37790665-gcode66x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode66x/icon.png',
  '/apps/37790665-gcode66x/192x192.icon.png',
  '/apps/37790665-gcode66x/512x512.icon.png',
  '/apps/37790665-gcode66x/manifest.json',
