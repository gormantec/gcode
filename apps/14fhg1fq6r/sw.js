const PRECACHE = 'precache-v1-14fhg1fq6r';
const RUNTIME = 'runtime-14fhg1fq6r';
const PRECACHE_URLS = [
  '/apps/14fhg1fq6r/index.html',
  '/apps/14fhg1fq6r/index.html?mockFrame=iphoneX',
  '/apps/14fhg1fq6r/icon.png',
  '/apps/14fhg1fq6r/192x192.icon.png',
  '/apps/14fhg1fq6r/512x512.icon.png',
  '/apps/14fhg1fq6r/manifest.json',
