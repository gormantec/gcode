const PRECACHE = 'precache-v1-37790665-v01';
const RUNTIME = 'runtime-37790665-v01';
const PRECACHE_URLS = [
  '/apps/37790665-v01/index.html',
  '/apps/37790665-v01/index.html?mockFrame=iphoneX',
  '/apps/37790665-v01/icon.png',
  '/apps/37790665-v01/192x192.icon.png',
  '/apps/37790665-v01/512x512.icon.png',
  '/apps/37790665-v01/manifest.json',
