const PRECACHE = 'precache-v1-6jqj05rdy5';
const RUNTIME = 'runtime-6jqj05rdy5';
const PRECACHE_URLS = [
  '/apps/6jqj05rdy5/index.html',
  '/apps/6jqj05rdy5/index.html?mockFrame=iphoneX',
  '/apps/6jqj05rdy5/icon.png',
  '/apps/6jqj05rdy5/192x192.icon.png',
  '/apps/6jqj05rdy5/512x512.icon.png',
  '/apps/6jqj05rdy5/manifest.json',
