const PRECACHE = 'precache-v1-37790665-gcode51x';
const RUNTIME = 'runtime-37790665-gcode51x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode51x/index.html',
  '/apps/37790665-gcode51x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode51x/icon.png',
  '/apps/37790665-gcode51x/192x192.icon.png',
  '/apps/37790665-gcode51x/512x512.icon.png',
  '/apps/37790665-gcode51x/manifest.json',
