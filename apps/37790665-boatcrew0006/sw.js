const PRECACHE = 'precache-v1-37790665-boatcrew0006';
const RUNTIME = 'runtime-37790665-boatcrew0006';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew0006/index.html',
  '/apps/37790665-boatcrew0006/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew0006/icon.png',
  '/apps/37790665-boatcrew0006/192x192.icon.png',
  '/apps/37790665-boatcrew0006/512x512.icon.png',
  '/apps/37790665-boatcrew0006/manifest.json',
