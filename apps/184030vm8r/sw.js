const PRECACHE = 'precache-v1-184030vm8r';
const RUNTIME = 'runtime-184030vm8r';
const PRECACHE_URLS = [
  '/apps/184030vm8r/index.html',
  '/apps/184030vm8r/index.html?mockFrame=iphoneX',
  '/apps/184030vm8r/icon.png',
  '/apps/184030vm8r/192x192.icon.png',
  '/apps/184030vm8r/512x512.icon.png',
  '/apps/184030vm8r/manifest.json',
