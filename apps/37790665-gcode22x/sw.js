const PRECACHE = 'precache-v1-37790665-gcode22x';
const RUNTIME = 'runtime-37790665-gcode22x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode22x/index.html',
  '/apps/37790665-gcode22x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode22x/icon.png',
  '/apps/37790665-gcode22x/192x192.icon.png',
  '/apps/37790665-gcode22x/512x512.icon.png',
  '/apps/37790665-gcode22x/manifest.json',
