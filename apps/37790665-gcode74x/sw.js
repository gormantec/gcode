const PRECACHE = 'precache-v1-37790665-gcode74x';
const RUNTIME = 'runtime-37790665-gcode74x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode74x/index.html',
  '/apps/37790665-gcode74x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode74x/icon.png',
  '/apps/37790665-gcode74x/192x192.icon.png',
  '/apps/37790665-gcode74x/512x512.icon.png',
  '/apps/37790665-gcode74x/manifest.json',
