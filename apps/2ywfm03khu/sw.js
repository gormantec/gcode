const PRECACHE = 'precache-v1-2ywfm03khu';
const RUNTIME = 'runtime-2ywfm03khu';
const PRECACHE_URLS = [
  '/apps/2ywfm03khu/index.html',
  '/apps/2ywfm03khu/index.html?mockFrame=iphoneX',
  '/apps/2ywfm03khu/icon.png',
  '/apps/2ywfm03khu/splash.png',
  '/apps/2ywfm03khu/180x180.icon.png',
  '/apps/2ywfm03khu/192x192.icon.png',
  '/apps/2ywfm03khu/512x512.icon.png',
  '/apps/2ywfm03khu/manifest.json',
