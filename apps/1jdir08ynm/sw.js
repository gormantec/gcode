const PRECACHE = 'precache-v1-1jdir08ynm';
const RUNTIME = 'runtime-1jdir08ynm';
const PRECACHE_URLS = [
  '/apps/1jdir08ynm/index.html',
  '/apps/1jdir08ynm/index.html?mockFrame=iphoneX',
  '/apps/1jdir08ynm/icon.png',
  '/apps/1jdir08ynm/192x192.icon.png',
  '/apps/1jdir08ynm/512x512.icon.png',
  '/apps/1jdir08ynm/manifest.json',
