const PRECACHE = 'precache-v1-37790665-gcode73x';
const RUNTIME = 'runtime-37790665-gcode73x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode73x/index.html',
  '/apps/37790665-gcode73x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode73x/icon.png',
  '/apps/37790665-gcode73x/192x192.icon.png',
  '/apps/37790665-gcode73x/512x512.icon.png',
  '/apps/37790665-gcode73x/manifest.json',
