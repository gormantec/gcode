const PRECACHE = 'precache-v1-37790665-swans-score';
const RUNTIME = 'runtime-37790665-swans-score';
const PRECACHE_URLS = [
  '/apps/37790665-swans-score/index.html',
  '/apps/37790665-swans-score/index.html?mockFrame=iphoneX',
  '/apps/37790665-swans-score/icon.png',
  '/apps/37790665-swans-score/splash.icon.png',
  '/apps/37790665-swans-score/180x180.icon.png',
  '/apps/37790665-swans-score/192x192.icon.png',
  '/apps/37790665-swans-score/512x512.icon.png',
  '/apps/37790665-swans-score/manifest.json',
