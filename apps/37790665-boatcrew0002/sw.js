const PRECACHE = 'precache-v1-37790665-boatcrew0002';
const RUNTIME = 'runtime-37790665-boatcrew0002';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew0002/index.html',
  '/apps/37790665-boatcrew0002/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew0002/icon.png',
  '/apps/37790665-boatcrew0002/192x192.icon.png',
  '/apps/37790665-boatcrew0002/512x512.icon.png',
  '/apps/37790665-boatcrew0002/manifest.json',
