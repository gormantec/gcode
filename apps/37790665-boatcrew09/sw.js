const PRECACHE = 'precache-v1-37790665-boatcrew09';
const RUNTIME = 'runtime-37790665-boatcrew09';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew09/index.html',
  '/apps/37790665-boatcrew09/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew09/icon.png',
  '/apps/37790665-boatcrew09/192x192.icon.png',
  '/apps/37790665-boatcrew09/512x512.icon.png',
  '/apps/37790665-boatcrew09/manifest.json',
