const PRECACHE = 'precache-v1-61dfu5gktx';
const RUNTIME = 'runtime-61dfu5gktx';
const PRECACHE_URLS = [
  '/apps/61dfu5gktx/index.html',
  '/apps/61dfu5gktx/index.html?mockFrame=iphoneX',
  '/apps/61dfu5gktx/icon.png',
  '/apps/61dfu5gktx/192x192.icon.png',
  '/apps/61dfu5gktx/512x512.icon.png',
  '/apps/61dfu5gktx/manifest.json',
