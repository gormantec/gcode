const PRECACHE = 'precache-v1-37790665-time';
const RUNTIME = 'runtime-37790665-time';
const PRECACHE_URLS = [
  '/apps/37790665-time/index.html',
  '/apps/37790665-time/index.html?mockFrame=iphoneX',
  '/apps/37790665-time/icon.png',
  '/apps/37790665-time/192x192.icon.png',
  '/apps/37790665-time/512x512.icon.png',
  '/apps/37790665-time/manifest.json',
