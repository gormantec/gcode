const PRECACHE = 'precache-v1-6ijc42sgew';
const RUNTIME = 'runtime-6ijc42sgew';
const PRECACHE_URLS = [
  '/apps/6ijc42sgew/index.html',
  '/apps/6ijc42sgew/index.html?mockFrame=iphoneX',
  '/apps/6ijc42sgew/icon.png',
  '/apps/6ijc42sgew/192x192.icon.png',
  '/apps/6ijc42sgew/512x512.icon.png',
  '/apps/6ijc42sgew/manifest.json',
