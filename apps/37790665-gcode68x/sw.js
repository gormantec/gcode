const PRECACHE = 'precache-v1-37790665-gcode68x';
const RUNTIME = 'runtime-37790665-gcode68x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode68x/index.html',
  '/apps/37790665-gcode68x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode68x/icon.png',
  '/apps/37790665-gcode68x/192x192.icon.png',
  '/apps/37790665-gcode68x/512x512.icon.png',
  '/apps/37790665-gcode68x/manifest.json',
