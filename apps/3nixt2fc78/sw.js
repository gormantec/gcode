const PRECACHE = 'precache-v1-3nixt2fc78';
const RUNTIME = 'runtime-3nixt2fc78';
const PRECACHE_URLS = [
  '/apps/3nixt2fc78/index.html',
  '/apps/3nixt2fc78/index.html?mockFrame=iphoneX',
  '/apps/3nixt2fc78/icon.png',
  '/apps/3nixt2fc78/splash.png',
  '/apps/3nixt2fc78/180x180.icon.png',
  '/apps/3nixt2fc78/192x192.icon.png',
  '/apps/3nixt2fc78/512x512.icon.png',
  '/apps/3nixt2fc78/manifest.json',
  'https://gcode.com.au/css/pwa.css'
];
self.addEventListener('install', event => {event.waitUntil(caches.open(PRECACHE).then(cache =>{let r=null;try{r=cache.addAll(PRECACHE_URLS);}catch(e){consol.log(e);};return r;}).then(self.skipWaiting()));});
