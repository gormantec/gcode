const PRECACHE = 'precache-v1-5jjss02l0r';
const RUNTIME = 'runtime-5jjss02l0r';
const PRECACHE_URLS = [
  '/apps/5jjss02l0r/index.html',
  '/apps/5jjss02l0r/index.html?mockFrame=iphoneX',
  '/apps/5jjss02l0r/icon.png',
  '/apps/5jjss02l0r/splash.png',
  '/apps/5jjss02l0r/180x180.icon.png',
  '/apps/5jjss02l0r/192x192.icon.png',
  '/apps/5jjss02l0r/512x512.icon.png',
  '/apps/5jjss02l0r/manifest.json',
