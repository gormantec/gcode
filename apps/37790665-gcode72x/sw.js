const PRECACHE = 'precache-v1-37790665-gcode72x';
const RUNTIME = 'runtime-37790665-gcode72x';
const PRECACHE_URLS = [
  '/apps/37790665-gcode72x/index.html',
  '/apps/37790665-gcode72x/index.html?mockFrame=iphoneX',
  '/apps/37790665-gcode72x/icon.png',
  '/apps/37790665-gcode72x/192x192.icon.png',
  '/apps/37790665-gcode72x/512x512.icon.png',
  '/apps/37790665-gcode72x/manifest.json',
