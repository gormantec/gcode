const PRECACHE = 'precache-v1-37790665-boatcrew05';
const RUNTIME = 'runtime-37790665-boatcrew05';
const PRECACHE_URLS = [
  '/apps/37790665-boatcrew05/index.html',
  '/apps/37790665-boatcrew05/index.html?mockFrame=iphoneX',
  '/apps/37790665-boatcrew05/icon.png',
  '/apps/37790665-boatcrew05/192x192.icon.png',
  '/apps/37790665-boatcrew05/512x512.icon.png',
  '/apps/37790665-boatcrew05/manifest.json',
