export function addFrame(win, aPWA, mockFrame) {
    ...
    div.className="material-icons";
    div.setAttribute("style", "position:fixed;top:20px;background-color:none;color:black;width:20px;margin-right:-50px;right: 20%;font-size:28px;-webkit-transform: rotate(90deg);-moz-transform: rotate(90deg);-ms-transform: rotate(90deg);transform: rotate(90deg)");
    aPWA.pwaOverlay.element.appendChild(div);
