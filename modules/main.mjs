...
function _createHtml() {
    ...
    if (splash && splash.substring(0, 4) == "http" && splash.substring(splash.length - 3) == "png") {
        ...
        _style.textContent = "\n.splash{position:absolute;background-image:url(" + splash + ");background-position:center;background-repeat:no-repeat;top:0px;bottom:0px;left:0px;right:0px;" + (splashColor ? "color:" + splashColor : "") + ";" + (splashBackgroundColor ? "background-color:" + splashBackgroundColor : "") + ";}\n" + spinnerCss + "\n";
