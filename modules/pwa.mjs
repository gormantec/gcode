...
class ActionButton extends Div{
    ...
    constructor(params) {
        ...
        if(params.innerText)
        {
            ...
            this.appendChild(new Div({tagName:"span",fontSize:params.fontSize?(params.fontSize+"px"):"24px",position:"absolute",top:params.fontSize?(((34-parseInt(params.fontSize))/2)+"px"):"5px",bottom:"0px",left:"0px",right:"0px",width:"unset",height:"unset",innerText:params.innerText}));
        }
