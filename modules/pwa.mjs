...
class AuthButtons extends Div {
    ...
    constructor(params) {
        ...
        if (params && (params.skip=="true" || params.skip==true)) this.appendChild(new Div({class:"floatingActionButton",innerText:"SKIP",onclick:()=>{myglobals.PWA.setPage(_nextPage);}}));
    }
}
