...
class AuthButtons extends Div {
    ...
    constructor(params) {
        ...
        if (params && (params.skip=="true" || params.skip==true)) this.appendChild(new Div({child:new ActionButton({marginLeft:"-90px",right:"unset",width:"180px",borderRadius:"2px",innerText:"SKIP",onclick:()=>{myglobals.PWA.setPage(_nextPage);}})}));
    }
}
