...
class PWA {
    constructor(params) {
        ...
        this.primaryColorText = params.primaryColorText || this.getTextColor(this.primaryColor);
    ...
    showNavigateBackButton() {
        ...
        this.pwaHeaderTitle.style.paddingLeft="40px";
    }
    hideNavigateBackButton() {
        this.navigateBackButton.style.display = "none";
        this.pwaHeaderTitle.style.paddingLeft="8px";
    }
...
class Div {
    ...
    constructor(params) {
        ...
        if (params && params.fontFamily) this.element.style.fontFamily = params.fontFamily;
        ...
        if (params && params.overflowY) this.element.style.overflowY = params.overflowY;  
            ...
            this.appendChild(new Div({
                child: new ActionButton({
                    ...
                    onclick: () => {
                        ...
                        myglobals.PWA.setCredentials({provider:"testemail",email:"test@testemail.com",imageUrl:"https://gcode.com.au/images/icons8-test-account-48.png",providerData:{user:{id:"test@testemail.com"}}});
